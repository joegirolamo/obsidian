...
import { X, FileText, Download, AlertTriangle, CheckCircle, XCircle, Info } from 'lucide-react';
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
          ...
          {activeTab === 'insights' && hasInsights && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mb-4">These insights are generated by AI analysis of the report data and context.</p>
        ...
        <div className="border-t border-gray-200 p-4 flex justify-between items-center bg-gray-50 rounded-b-lg">
          <div className="text-sm text-gray-500">
            ...
            ) : report.importSource === 'api' ? 'Imported via API Connection' : 'Manual Entry'}
