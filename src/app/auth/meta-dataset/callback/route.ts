...
export async function GET(request: Request) {
  try {
    ...
    return NextResponse.redirect(
      new URL(`/connect/${businessCode}?success=Meta Dataset connected successfully`, request.url)
    );
  } catch (error) {
    console.error('Error in Meta Dataset callback:', error);
