...
import { saveMetricAction, updateMetricAction, deleteMetricAction, createDefaultMetricsAction, createDefaultToolsAction, getBusinessMetricsAction, getBusinessToolsAction, updateToolRequest } from '@/app/actions/serverActions';
...
const BusinessDetailsPage = () => {
  ...
  const [connectionRequests, setConnectionRequests] = useState<ConnectionRequest[]>([
    { id: '1', name: 'Google Analytics', isConnected: true, icon: 'ga' },
    { id: '2', name: 'Facebook Ads', isConnected: false, icon: 'fb' },
    { id: '3', name: 'Shopify', isConnected: false, icon: 'shopify' },
    { id: '4', name: 'QuickBooks', isConnected: false, icon: 'qb' },
  ]);
